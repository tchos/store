...
public class PosteController {
    ...
    {
        Poste poste = posteService.getPosteById(id).orElseThrow(() -> new EntityNotFoundException("Poste non existant !"));
    ...
    public String update(@PathVariable UUID id, @Valid @ModelAttribute("poste") Poste poste,
                         BindingResult bindingResult,
                         Model model,
                         RedirectAttributes ra)
    {
        ...
        try
        {
            ...
            // Après la modification d'un poste on se redirige vers la page des listes des postes
            return "redirect:/poste";
